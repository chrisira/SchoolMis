...
<h4 class="card-title mb-4">Add class</h4>
        ...
        <div class="card">
            <div class="card-body">
                <form action="submissions.php" method="POST">
                   ...
                   <option selected="true" disabled="disabled" value="" required>--select Year-- </option>
                
                <?php
    
                $years = $db->GetRows("SELECT * FROM school_year");
                $flag = 0;
                foreach($years as $years){
                $flag++;
                ?>
                   <option value="<?=$years['id']?>" name="year"><?=$years['school_year']?></option>
                 <?php
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <button type="submit" class="btn btn-success waves-effect waves-light me-1" name="save_class">
                                Save
                            </button>
