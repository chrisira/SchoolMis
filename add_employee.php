        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                   ...
                   <option selected="true" disabled="disabled" value="" required>--select job Title-- </option>
                ...
                $flag++;
                ?>
                   <option value="<?=$jobs['id']?>" name="title"><?=$jobs['title']?></option>
                 <?php
                        ...
                        <div>
                            <button type="submit" class="btn btn-info waves-effect waves-light me-1" name="save_employee">
                                Save
                            </button>
