        ...
        <div class="card">
            <div class="card-body">
                <form action="submissions.php" method="POST">
                   ...
                   <option selected="true" disabled="disabled" value="" required>--select job-- </option>
                ...
                ?>
                 ...
                 <?php
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <button type="submit" class="btn btn-success waves-effect waves-light me-1" name="save_salary">
                                Save
                            </button>
