...
<h4 class="card-title mb-4">Add Shift</h4>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                $classes = $db->GetRows("SELECT * FROM class");
                $flag = 0;
                foreach($classes as $classes){
                $flag++;
                ?>
                   <option value="<?=$classes['id']?>" name="class"><?=$classes['names']?></option>
                 <?php
                   ...
                   <option selected="true" disabled="disabled" value="" required>--select Shift-- </option>
                   ...
                   <option value="night" name="shift">Night</option>
                        ...
                        <div>
                            <button type="submit" class="btn btn-primary waves-effect waves-light me-1" name="save_shift">
                                Save
                            </button>
