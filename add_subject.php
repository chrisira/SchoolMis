            ...
            <div class="card-body">
                <form action="submissions.php" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Enter Subject title" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label>Credits</label>
                        <input type="number" name="credits" class="form-control" placeholder="Enter Credits" required>
                    </div>

                    
                        <div>
                            <button type="submit" class="btn btn-warning waves-effect waves-light me-1" name="save_subject">
                                Save
                            </button>
