...
<h4 class="card-title mb-4">Assign Subject</h4>
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="mb-3">
                   ...
                   <option selected="true" disabled="disabled" value="" required>--select Teacher-- </option>
                
                <?php
    
                $employees = $db->GetRows("SELECT * FROM employees");
                $flag = 0;
                foreach($employees as $employees){
                $flag++;
                ?>
                   <option value="<?=$employees['id']?>" name="employee_name"><?=$employees['names']?></option>
                 <?php
                        ...
                        <div>
                            <button type="submit" class="btn btn-dark waves-effect waves-light me-1" name="assign_subject">
                                Assign
                            </button>
