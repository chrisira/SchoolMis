...
<div class="card-body">
    ...
    <div class="p-3">
        <form class="form-horizontal mt-3" action="../submissions.php" method="post">
            ...
            <div class="form-group mb-3 row">
                <div class="col-12">
                    <input class="form-control" type="text" required="" placeholder="Username" name="names">
                </div>
            </div>
            <div class="form-group mb-3 row">
                <div class="col-12">
                    Role : <select name="role" class="form-control" id="">
            ...
            <div class="form-group text-center row mt-3 pt-1">
                <div class="col-12">
                    <button class="btn btn-info w-100 waves-effect waves-light" name="register" type="submit">Register</button>
                </div>
            </div>
